...
import router, { constantRoutes, topNavRoutes } from '@/router';
...
const usePermissionStore = defineStore('permission', {
  state: () => ({
    ...
    addRoutes: new Array<any>(),
    defaultRoutes: new Array<any>(),
    topbarRouters: new Array<any>(),
    sidebarRouters: new Array<any>(),
    isInited: false /*是否路由已经初始化*/,
  }),
  actions: {
    ...
    setInited(initFlag: boolean) {
      this.isInited = initFlag;
    },
