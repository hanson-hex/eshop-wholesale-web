<template>
  <div class="classification">
    <div class="card">
      <div class="staus_bar fl_bet border">
        ...
        <div class="detail_right">
          ...
          <el-button v-if="Number(orderList.status) == 3" type="danger emphasis_btn">确认收货</el-button>
          <el-button v-if="Number(orderList.status) == 1" class="cancel_btn" :loading="isLoading" @click.stop="cancelClick(id)">取消订单</el-button>
        </div>
      </div>
        ...
        <el-collapse-item name="1">
          ...
          <div style="padding-top: 10px">
            <el-timeline v-if="expressData.child && expressData.child.length > 0">
              <el-timeline-item v-for="(activity, index) in expressData.child" :key="index" color="#0da1a8">
    ...
    <el-dialog :visible.sync="isQrCode" width="800px" :destroy-on-close="true" :close-on-click-modal="false" :close-on-press-escape="false" :before-close="qrCodeBtn" class="codeCont">
      <div class="qrcodeCon">
