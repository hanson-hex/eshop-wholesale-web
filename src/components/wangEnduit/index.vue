  ...
  methods: {
    seteditor () {
      ...
      this.editor.config.uploadImgServer =
        'https://gateway.cbyyk.com' + '/product/goodsbase/upload' // 配置服务器端地址
      ...
      this.editor.config.onchange = (html) => {
        ...
        this.$emit('changeEndit', this.info_) // 将内容同步到父组件中
      }
      // 创建富文本编辑器
      this.editor.create()
    }
